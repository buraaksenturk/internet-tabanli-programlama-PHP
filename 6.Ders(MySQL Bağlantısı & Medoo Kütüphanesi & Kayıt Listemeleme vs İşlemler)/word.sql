...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 07 Ağu 2020, 09:34:20
...
-- Yordamlar
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `adresbilgi` ()  BEGIN
SELECT * FROM adres;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `turkiyeSehirler` ()  BEGIN

select * from sehirler WHERE sehirler.ulke_kodu="TUR";
...
CREATE TABLE `sehirler` (
  `ID` int(11) NOT NULL COMMENT 'birincil alan',
  `isim` char(35) NOT NULL DEFAULT '' COMMENT 'şehir ismi',
  `ulke_kodu` char(3) NOT NULL DEFAULT '' COMMENT 'şehrin bulunduğu ülke kodu',
  `bolge` char(20) NOT NULL DEFAULT '' COMMENT 'şehrin ülkede bulunduğu bölge adı',
  `nufus` int(11) NOT NULL DEFAULT 0 COMMENT 'şehir nüfusu'
...
INSERT INTO `sehirler` (`ID`, `isim`, `ulke_kodu`, `bolge`, `nufus`) VALUES
...
--
-- Tablo için tablo yapısı `ulkedilleri`
--

CREATE TABLE `ulkedilleri` (
  `ulke_kodu` char(3) NOT NULL DEFAULT '' COMMENT 'ülke kodu',
  `dil` char(30) NOT NULL DEFAULT '' COMMENT 'dil ismi',
  `resmi_mi` enum('T','F') NOT NULL DEFAULT 'F' COMMENT 'dil resmi mi (T:evet, F:hayır)',
  `oran` float(4,1) NOT NULL DEFAULT 0.0 COMMENT 'Dilin konuşulma oranı'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Tablo döküm verisi `ulkedilleri`
--

INSERT INTO `ulkedilleri` (`ulke_kodu`, `dil`, `resmi_mi`, `oran`) VALUES
('ABW', 'Dutch', 'T', 5.3),
('ABW', 'English', 'F', 9.5),
...
CREATE TABLE `ulkeler` (
  `kod` char(3) NOT NULL DEFAULT '' COMMENT 'ülke kodu',
  `isim` char(52) NOT NULL DEFAULT '' COMMENT 'ülke ismi',
  `kita` enum('Asia','Europe','North America','Africa','Oceania','Antarctica','South America') NOT NULL DEFAULT 'Asia' COMMENT 'ülkenin bulunduğu kıta',
  `bolge` char(26) NOT NULL DEFAULT '' COMMENT 'ülkenin yer aldığı bölge',
  `yuzolcumu` float(10,2) NOT NULL DEFAULT 0.00 COMMENT 'ülkenin yüzölçümü',
  `bagimsizlk_yili` smallint(6) DEFAULT NULL COMMENT 'ülkenin bağımsılığına kavuştuğu yıl',
  `nufus` int(11) NOT NULL DEFAULT 0 COMMENT 'ülke nüfusu',
  `ort_yasam_suresi` float(3,1) DEFAULT NULL COMMENT 'ülekedeki insanların ortalama yaşam süresi',
  `GSMH` float(10,2) DEFAULT NULL COMMENT 'Gayri Safi Milli Hasıla',
  `eski_GSMH` float(10,2) DEFAULT NULL COMMENT 'Gayri Safi Milli Hasılanın eski değeri',
  `yerel_isim` char(45) NOT NULL DEFAULT '' COMMENT 'ülkenin yerel adı',
  `yonetim_sekli` char(45) NOT NULL DEFAULT '' COMMENT 'ülkenin yönetim şekli',
  `baskan` char(60) DEFAULT NULL COMMENT 'ülkenin başkanının adı',
  `baskent` int(11) DEFAULT NULL COMMENT 'ülkenişn başkent id''si',
  `kisa_kod` char(2) NOT NULL DEFAULT '' COMMENT 'kısa ülke kodu '
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `ulkeler` (`kod`, `isim`, `kita`, `bolge`, `yuzolcumu`, `bagimsizlk_yili`, `nufus`, `ort_yasam_suresi`, `GSMH`, `eski_GSMH`, `yerel_isim`, `yonetim_sekli`, `baskan`, `baskent`, `kisa_kod`) VALUES
...
ALTER TABLE `sehirler`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `ulke_kodu` (`ulke_kodu`);

--
-- Tablo için indeksler `ulkedilleri`
--
ALTER TABLE `ulkedilleri`
  ADD PRIMARY KEY (`ulke_kodu`,`dil`),
  ADD KEY `ulke_kodu` (`ulke_kodu`);
...
--
ALTER TABLE `sehirler`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'birincil alan', AUTO_INCREMENT=4080;
COMMIT;
