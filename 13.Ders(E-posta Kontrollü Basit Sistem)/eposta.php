...
if(isset($_POST["kad"]) && isset($_POST["sifre"])){
    if($_POST["kad"]!="" && $_POST["sifre"]!="" ){
        ...
        $database->insert("users", ["kad" => $kAd, "sifre" => $sifre, "aktivasyon" => $aktivasyon_dkod]);
        ...
        try {
            ...
            $mail->Body    = 'Kayıt olduğunuz için teşekkürler, <br> Hesabınızı aktif etmek için <a href="localhost/aktif_et.php_?mail=buraak.senturk@gmail.com&kod='.$aktivasyon_dkod.'"><b>tıklayınız</b>.</a>';
